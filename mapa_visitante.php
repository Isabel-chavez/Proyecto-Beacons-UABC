      ...
      function initMap() {
         ...
         */
         ...
         // for($i=0; $i<=count($info_nodo1);$i++){ 
          ...
          "</p>" +
          '<div id="icono"><div class="row"><div class="col-md-5"><img src="./assets/icons/<?php echo $info_nodo1['color'];?>.png"></div><div class="col-md-7" style="display:block">'+
         ...
         <?php // } ?>
          ...
          "</p>" +       
          '<div id="icono"><div class="row"><div class="col-md-4"><img src="./assets/icons/<?php echo $info_nodo3['color'];?>.png"></div><div class="col-md-8" style="display:block"><b>Nota:</b>Existe rango de error en la medición el valor es informativo no exacto</div></div></div>' +
          ...
          "</p>" +
          '<div id="icono"><div class="row"><div class="col-md-4"><img src="./assets/icons/<?php echo $info_nodo4['color'];?>.png"></div><div class="col-md-8" style="display:block"><b>Nota:</b>Existe rango de error en la medición el valor es informativo no exacto</div></div></div>' +
          /* "<br><?php echo date('d/m/Y');?></p>"+  */
          "<br></div>" +
          "</div>";
